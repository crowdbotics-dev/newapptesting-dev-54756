...
## Project Structure
    ...
    ├── newapptesting_dev_54756  # Django project configurations
...
1. Clone this repo and `cd newapptesting_dev_54756`
...
2. Clone this repo and `cd newapptesting_dev_54756`
